...
export async function getStaticProps() {
  const en_version =
    "https://docs.google.com/document/d/e/2PACX-1vSnuRk2TQCGwikEJGVoEumtgc4_RZM4dgA6XZHpeYWCWVqm8WMs1Wb_wLkiF-mxZjZ67XdJqMSz8UM_/pub?embedded=true";
  const es_version =
    "https://docs.google.com/document/d/e/2PACX-1vTBd468jCVVFk-rkYPFVZp96VrOgxN4TShRlS7D-v-TvwmhL38k4mIOETC0Q3uzOfKwqkAGFKhcpBqx/pub?embedded=true";
