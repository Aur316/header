...
const WEBFLOW_BASE_URL = "https://testing-22bb2e.webflow.io/newspages/";

const NewsPage: NextPage<{ htmlContent: string; pageNotFound: boolean }> = ({
  htmlContent,
  pageNotFound,
}) => {
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  ...
  if (context.locale === "es-ES" && !slug.endsWith("-esp")) {
    return {
      redirect: {
        destination: `/es-ES/newspages/${slug}-esp`,
        permanent: false,
      },
    };
  }
